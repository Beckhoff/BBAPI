...
#define CONFIG_EXPECTED_BBAPI_BL_REVISION {0, 14, 0}
#define CONFIG_EXPECTED_BBAPI_FW_REVISION {0, 17, 36}
#define CONFIG_EXPECTED_BBAPI_PWRCTRL_DEVICE_ID 0xC
#define CONFIG_EXPECTED_BBAPI_PWRCTRL_POSITION 0x00
