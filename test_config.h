...
#endif
#if (TEST_DEVICE == DEVICE_CX2030_CX2100_0004)
...
#define CONFIG_CXUPS_ENABLED (0x0904 == CONFIG_CXPWRSUPP_TYPE)
...
#define CONFIG_CXUPS_BOOTCOUNTER_RANGE 1, 1
